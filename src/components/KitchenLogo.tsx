 ...
 * the accent dash was removed at the client's request (Sep 2026 review) — the
 * lockup is now wordmark + divider + dash only. The dash stays the brand's
 * approved secondary red (#AF1718), same source as `theme.error` in
 * src/utils/theme.ts, and is the one pop of colour in an otherwise
...
const compactOverrides = {
  ...
  accentDash: { width: 20, height: 2.5, marginTop: 10 },
};
